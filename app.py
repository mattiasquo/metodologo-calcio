...
# Funzione per comprimere l'immagine per un invio ultra-veloce
...
if submit_button:
    if uploaded_file is None:
        ...
        try:
            ...
            base64_image = process_and_encode_image(uploaded_file)
            ...
            # Modelli Vision gratuiti e ultra-veloci
            models_to_try = [
            ...
            for model_name in models_to_try:
                try:
                    # Inizializza lo streaming nel contenitore
                    stream = client.chat.completions.create(
                        model=model_name,
                        max_tokens=1200,
                        stream=True,  # Attiva lo streaming parola per parola
                        messages=[
                            {
                                "role": "user",
                                "content": [
                    ...
                    # Mostra il testo in tempo reale mentre viene inviato
            ...
            if not success:
                st.error("I server gratuiti sono al momento sovraccarichi. Riprova tra qualche istante.")
