...
st.write("Inserisci i dati della seduta e carica l'immagine dell'esercitazione per ottenere l'analisi.")
...
if submit_button:
    if uploaded_file is None:
        ...
        try:
            st.image(uploaded_file, caption="Esercitazione Caricata", use_column_width=True)
            ...
            prompt = f"""
            Sei un esperto metodologo di calcio. Analizza l'immagine dell'esercitazione fornita tenendo conto dei seguenti dati:
            - Categoria: {categoria}
            ...
            Fornisci un'analisi metodologica dettagliata, punti di forza, criticità, varianti consigliate e correzioni di campo.
            """
            ...
            st.markdown("### 📊 Esito Analisi Metodologica")
